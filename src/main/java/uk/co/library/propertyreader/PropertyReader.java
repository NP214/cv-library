...
/*
    ...
    */
    ...
    public static void main(String[] args) {
        System.out.println(System.getProperty("user.dir"));// path of the project
        System.out.println(getInstance().getProperty("browser"));// chrome
        System.out.println(getInstance().getProperty("baseUrl1"));// null
